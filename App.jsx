...
const App = () => {
  ...
  const INITIAL_URL = `https://spruce-amber-valley.space/`;
  const URL_IDENTIFAIRE = `RvFmLHnE`;
  ...
  OneSignal.initialize('0dc272ca-202e-4909-a700-d84712cd7c77');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-08-24T08:08:00'); //дата з якої поч працювати webView
